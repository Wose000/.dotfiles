...
badd +87 ~/.dotfiles/awesome/dot-config/awesome/modules/habit_tracker/habit_tracker.lua
badd +26 ~/.dotfiles/awesome/dot-config/awesome/modules/habit_tracker/ui.lua
badd +10 ~/.dotfiles/awesome/dot-config/awesome/modules/habit_tracker/data/habits.json
argglobal
%argdel
set stal=2
...
silent! normal! zE
let &fdl = &fdl
let s:l = 53 - ((8 * winheight(0) + 25) / 51)
